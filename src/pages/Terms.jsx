    ...
    <section className="min-h-screen bg-gray-50 py-24">
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <Section title="7. 결제·환불 및 청약철회" id="refund">
          <p>
            <strong className="text-gray-900">유료 서비스</strong>: 포인트 충전(10,000원·30,000원·50,000원·100,000원 고정 패키지, 1포인트 = 1원)과
            포인트로 구매하는 매칭신청권(1개 30,000포인트)입니다. 결제는 결제대행사를 통해 신용카드 등 결제대행사가 제공하는 수단으로 이루어집니다.
          </p>
          <p>
            <strong className="text-gray-900">제공 기간·교환</strong>: 포인트는 결제 완료 즉시 회원 계정에 적립되며 별도의 제공 기간이 없습니다.
            포인트와 매칭신청권은 실물이 아닌 디지털 상품이므로 교환은 제공하지 않으며, 취소·환불로 처리합니다.
          </p>
          <p>
