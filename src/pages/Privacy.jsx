      ...
      <div className="mx-auto px-4 max-w-3xl">
        ...
        <Section title="2. 개인정보의 이용 목적">
          <ul className="ml-4 list-disc space-y-1">
            ...
            <li>승무원 인증 대상 항공사 등록 검토 및 결과 안내(항공사 추가 요청)</li>
        ...
        <Section title="6. 보유 및 파기">
          ...
          <p>
            항공사 추가 요청으로 받은 항공사명·회사 이메일 주소는 해당 항공사의 등록 검토와 결과 안내라는
            목적을 달성할 때까지 보관합니다.
          </p>
          <p>
          ...
          <p>
            게시판 글쓰기에서 임시저장한 글은 회원이 지우거나 탈퇴하면 바로 삭제하고, 그 글을 등록하면 함께 지웁니다.
            같은 편 게시판의 임시저장 글은 출발일이 지나 게시판이 닫히면 삭제합니다.
          </p>
          <p>
        ...
        <Section title="개정 이력">
          <ul className="ml-4 list-disc space-y-1">
            <li>2026-09-17: 항공사 추가 요청(항공사명·회사 이메일) 수집 항목과 이용 목적 추가</li>
